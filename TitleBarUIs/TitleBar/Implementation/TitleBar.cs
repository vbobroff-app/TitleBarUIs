...
namespace TitleBarUIs
{
    ...
    public class TitleBar : Control
    {
        ...
        public TitleBar()
        {
            ...
            windowButtons.SetBinding(WindowButtonsBase.ThemeStyleProperty, binding);
            ...
            imageIcon.SetBinding(TitleBarUIs.ImageIcon.IconProperty, uBinding);
         
            var hBinding=new Binding("IconSize") {Source = this};
            imageIcon.SetBinding(HeightProperty, hBinding);
